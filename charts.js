 ...
 */
 ...
 //const okey = {"headers":{"Accept":"application/json","Content-Type":"application/json","monKey":"BoomBoomBoom"},"path":"http://localhost:7555/deathcount/g"};
...
core_defaults._set('global', {
	elements: {
		point: {
			...
			hitRadius: 1,
			hoverRadius: 4,
			hoverBorderWidth: 3//here here here default = 1
		}
	}
});
...
core_defaults._set('polarArea', {
	...
	tooltips: {
		callbacks: {
			...
			label: function(item, data) {
				return data.labels[item.index] + ': ' + item.yLabel + 'booooooom';
			}
		}
	}
});
...
core_defaults._set('scatter', {
	...
	tooltips: {
		callbacks: {
			...
			label: function(item) {
				return '(' + item.xLabel + ', ' + item.yLabel + ' biff)';
			}
		}
	}
});
...
var core_interaction = {
	...
	modes: {
		...
		point: function(chart, e) {
			var position = getRelativePosition(e, chart);
      console.log('getRelativePosition::', getRelativePosition(e, chart));
...
core_defaults._set('global', {
	tooltips: {
      ...
      //  console.log('title::', title);
          ...
          //her her here is where we wantt a promir if if it infact necessary
